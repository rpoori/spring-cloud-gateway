...
public class CircuitBreakerScenarioOneTest extends BaseGatewayTest {
    ...
    public static void init() {
        ...
        System.setProperty("wait.duration.open.state.milliseconds", "1");
    ...
    public void test() {
        stubFor(get(urlEqualTo("/api/microservice-one/1"))
                .willReturn(aResponse()
                        .withStatus(200)));

        stubFor(get(urlEqualTo("/api/microservice-one/2"))
                .willReturn(aResponse()
                    .withStatus(200)
                    .withFixedDelay(500)));
        ...
        FluxExchangeResult<String> stringFluxExchangeResult = testClient.get().uri("/api/microservice-one/" + gen)
